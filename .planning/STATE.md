...
**Current focus:** P1 physical-device validation on `feature/pitch-lab-v2` while V1 remains preserved on `main` and at `/pitchlab/`.

## Status

- Phase: Product P1 / internal Phase 2 implemented; Product P2 / internal Phase 3 follows
- State: P1 automated implementation and separate preview deployment complete; physical-device release gates pending
- Plan: `.planning/phases/02-p1-practice-harmony/02-01-PLAN.md`
- Next plan: `.planning/phases/03-p2-score-game/03-01-PLAN.md`
- Last activity: 2026-07-20 — P1 deployed separately at `https://dexa.art/pitch-lab-v2/`; V1 production remains at `https://dexa.art/pitchlab/`
...
- V2 preview: live at `https://dexa.art/pitch-lab-v2/`; this does not replace the V1 production route.
